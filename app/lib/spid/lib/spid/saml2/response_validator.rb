  ...
  module Saml2
    class ResponseValidator # :nodoc:
      ...
      def call
		...
		[
          response_id, version,
          assertion_version, assertion_id, assertion_nameid, assertion_nameid_format, assertion_nameid_namequalifier,
          assertion_subjectconfirmation, assertion_subjectconfirmation_method,
          assertion_subjectconfirmationdata_notonorafter, assertion_conditions, assertion_conditions_notbefore, assertion_authnstatement, assertion_authnstatement_authncontext,
          assertion_attributestatement,
          issuer, assertion_issuer, certificate, destination, conditions, audience, signature
        ].all?
      end

      def response_id
        return true unless response.element_from_xpath(response.saml_or_saml2('/samlp:Response/@ID')).blank?
      ...
      def assertion_id
        return true unless response.element_from_xpath(response.saml_or_saml2('/samlp:Response/saml:Assertion/@ID')).blank?
      ...
      def assertion_nameid
        return true unless response.element_from_xpath(response.saml_or_saml2('/samlp:Response/saml:Assertion//saml:NameID/text()')).blank?
      ...
      def assertion_nameid_namequalifier
        ...
        return true unless namequalifier.blank?
      ...
      def assertion_subjectconfirmation
        return true unless response.document.elements[response.saml_or_saml2('/samlp:Response/saml:Assertion//saml:SubjectConfirmation//saml:SubjectConfirmationData')].blank?
      ...
      def assertion_conditions_notbefore
        ...
        return true unless notbefore.blank?
      ...
      def assertion_attributestatement
        ...
        return true unless assertion_attributestatement.blank?
