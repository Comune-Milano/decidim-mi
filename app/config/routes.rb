Rails.application.routes.draw do
  ...
  get 'admin/pdf_signeds/:id', :to => 'admin/pdf_signeds#index',  :as => 'pdf_signeds'
  post 'admin/pdf_signeds/:id' => 'admin/pdf_signeds#create'
  delete 'admin/pdf_signeds/:id', :to => 'admin/pdf_signeds#destroy', :as => 'pdf_signed'

  get 'admin/pdf_signeds/:id/new', :to => 'admin/pdf_signeds#new', :as =>'new_pdf_signed'
