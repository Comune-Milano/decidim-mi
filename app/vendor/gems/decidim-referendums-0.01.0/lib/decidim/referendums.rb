...
require "decidim/referendums/admin"
require "decidim/referendums/engine"
require "decidim/referendums/admin_engine"
require "decidim/referendums/participatory_space"

module Decidim
  # Base module for the referendums engine.
  module Referendums
    ...
    # referendums similar. Defaults to 0.25.
    config_accessor :similarity_threshold do
      0.25
    end

    # Public Setting that defines how many similar referendums will be shown.
    # Defaults to 5.
    config_accessor :similarity_limit do
      5
    end

    # Minimum number of committee members required to pass the referendum to
    # technical validation phase. Only applies to referendums created by
    # individuals.
    config_accessor :minimum_committee_members do
      2
    end

    # Number of days available to collect supports after an referendum has been
    # published.
    config_accessor :default_signature_time_period_length do
      120
    end

    # Components enabled for a new referendum
    ...
    # After this time the referendum will be moved to
    # discarded state.
    ...
    # a printed version of the referendum from the administration
    # panel.
