    ...
    module Admin
      class Permissions < Decidim::DefaultPermissions
        ...
        def user_can_read_participatory_space?
          ...
          toggle_allow(user.admin? || user.role?("initiative_manager") || initiative.has_authorship?(user) )
        end
        ...
        def user_can_enter_space_area?
          ...
          toggle_allow(user.admin? || has_initiatives? || user.role?("initiative_manager"))
        end
