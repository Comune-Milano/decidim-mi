...
Decidim.register_component(:proposals) do |component|
  ...
  component.data_portable_entities = ["Decidim::Proposals::Proposal", "Decidim::Component"],
  ...
  component.settings(:global) do |settings|
    ...
    settings.attribute :proposal_edit_before_minutes, type: :integer, default: 0
    settings.attribute :threshold_per_proposal, type: :integer, default: 0
    settings.attribute :amendments_enabled, type: :boolean, default: false
    settings.attribute :testo_originale, type: :boolean, default: false
